...
space = {
    'units1': hp.quniform('units1', 0, 10000, 25), #implementation of hq.uniform is weird see github.com/hyperopt/hyperopt/issues/321
    'batch_size': hp.choice('batch_size', [30])
    }

space_str = """
space = {
    'units1': hp.quniform('units1', 0, 10000, 25), 
    'batch_size': hp.choice('batch_size', [30])
    }"""
