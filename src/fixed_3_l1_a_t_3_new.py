...
def objective(params):
    ...
    enc2 = Dense(layer2, activation='relu',activity_regularizer=regularizers.l1(0.000001))(enc)
    dec1 = Dense(layer1, activation='relu',activity_regularizer=regularizers.l1(0.000001))(enc2)
